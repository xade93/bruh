...
export const TokenABI = require("./artifacts/contracts/Token.sol/DUT.json").abi;
export const AuctionABI = require("./artifacts/contracts/Auction.sol/DutchAuction.json").abi
